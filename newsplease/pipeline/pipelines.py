...
class MySQLStorage(ExtractedInformationStorage):
    """
    Handles remote storage of the meta data in the DB
    If using MariaDB, required version 10.5 or later
    """
    ...
    def process_item(self, item, spider):
        ...
        current_version_list['authors'] = json.dumps(current_version_list['authors'])
        ...
        try:
            ...
            print(current_version_list["authors"])
